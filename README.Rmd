...
```
Regresa un nuevo data frame con la distancia maxima de la colonia por viaje.

#### calcular_tripparams 📐⏳📏
Calcula la duracion de los viajes, la distancia maxima de la colonia y la distancia total recorrida.
```{r, eval=FALSE}
