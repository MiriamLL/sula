...
**GPS_preparado** is your data frame with the columns "Latitude" and "Longitude"  
Set an **interval**, for example "900 secs"   
Define which is the name of the column that contains the information from day and time (**col_diahora**). For example: "tStamp"  
A **separator**, for example, 'trip_number'  
This function runs for several individuals therefore the **col_ID** should correspond to the name of your column with the individuals' ID   
