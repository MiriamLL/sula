...
#'
#' @param GPS_data data frame con los datos de GPS debe contener columna de latitud y de longitud en formato numerico.
...
#' @export
#'
#' @examples nest_loc<-localizar_nido(GPS_data = GPS_01,lat_col="Latitude",lon_col="Longitude")
localizar_nido<-function(GPS_data=GPS_data,
                         lon_col=lon_col,
                         lat_col=lat_col){
